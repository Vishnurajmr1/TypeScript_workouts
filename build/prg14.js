...
let limit = parseInt(promptInput("Enter the size of array"));
let array1 = [];
let array2 = [];
...
for (let i = 0; i < limit; i++) {
    ...
    for (let j = 0; j < limit; j++) {
        const values = parseInt(promptInput(`Enter the value at index ${i + 1} of array1: `));
        array1[i][j] = values;
    }
}
...
for (let i = 0; i < limit; i++) {
    array2[i] = [];
    for (let j = 0; j < limit; j++) {
        const values = parseInt(promptInput(`Enter the value at index ${i + 1} of array2: `));
        array2[i][j] = values;
    }
}
//adding two arrays
